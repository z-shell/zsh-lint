...
func TestFunctionNamespaceDeclarations(t *testing.T) {
	tests := []struct {
		...
		{name: "foreign unload hook", source: "other-plugin_plugin_unload() { :; }\n", identifier: "zsh-eza", want: 1},
		{name: "unload hook prefix only", source: "zsh-eza_plugin_unload_extra() { :; }\n", identifier: "zsh-eza", want: 1},
...
func TestFunctionNamespaceAutoloadBasenames(t *testing.T) {
	tests := []struct {
		...
		{name: "literal unload hook", path: "functions/zsh-eza_plugin_unload", identifier: "zsh-eza", want: 0},
		{name: "foreign unload hook", path: "functions/other-plugin_plugin_unload", identifier: "zsh-eza", want: 1},
